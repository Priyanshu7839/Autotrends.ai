...
const MonthlyAnalysisIndia = ({PanIndiaData}) => {
...
const data10 = {
  ...
  return (
    <div className="w-full flex items-stretch justify-between gap-[1rem] bg-transparent">
      <div className="w-[100%] border-[1px] border-[#cfcfd5] rounded-[12px] p-[1rem] flex flex-col gap-[1rem] glass-card">
        <div className="flex items-center justify-between">
          <h1 className="font-1 font-medium text-[1rem] flex items-center gap-[.5rem]">
            <FaChartBar />
            Monthly Analysis For {selectedBrandIndiaMonthly?.split(" ")[0]} in
            India
          </h1>
          ...
          <button
            className={`text-[#0b85ff] text-[.875rem] flex items-center justify-between gap-[.25rem] cursor-pointer relative px-[.5rem] py-[.25rem] border-[1px] border-[#0b85ff] rounded-[8px]  ${
              selectedBrandIndiaMonthlyView && "rounded-b-[0px] border-b-0"
            }`}
            onClick={() => {
              setselectedBrandIndiaMonthlyView(!selectedBrandIndiaMonthlyView);
            }}
          >
            {selectedBrandIndiaMonthly?.split(" ")[0]}{" "}
                ...
                return (
                  <h1
                    ...
                    className={` py-[.25rem] 
                           `}
                    onClick={() => {
                      setselectedBrandIndiaMonthly(item.brand);
                    }}
                  >
                    {item.brand.split(" ")[0]}
                  </h1>
...
export default MonthlyAnalysisIndia;
