...
const StatesErrorPopup = ({ showStatesError, setShowStatesError }) => {
  return (
     <div
      className={`absolute w-full h-full bg-[rgba(0,0,0,0.7)] items-center justify-center z-[999]
    ${showStatesError ? "flex" : "hidden"}
    `}
    >
        <div className="w-[520px] bg-[white] h-[280px] rounded-[8px]  p-[3rem] py-[3rem] flex items-start justify-start relative border-[1px] border-[#cfcfd7]">
                                  <div className="flex flex-col gap-[1rem]">
                                    <div>
                                     <h1 className=" text-[2.5rem] font-2">States Switching </h1>
                                  ...
                                  <div className='w-full flex items-center   justify-center'>
                                    <button 
                                    onClick={()=>{setShowStatesError(false)}}
...
export default StatesErrorPopup