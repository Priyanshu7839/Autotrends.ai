...
const PopularBrandsSection11 = () => {

    const breakpoint=useScreenResizeValue();

  return (
    <div className=' w-full  relative  py-[16px] flex flex-col rounded-[16px] border border-[rgba(36,39,44,0.1)] shadow-[0px_1px_2px_rgba(36,39,44,0.1)] gap-[8.6px]'>
    <h3 className="  text-[23px] px-[21px]  leading-[33.2px] font-[500] ">
       ...
       <div className={` ${breakpoint<=412?' w-full overflow-x-scroll px-[21px]':' w-full px-[10px] grid grid-cols-2 gap-x-[20px] gap-y-[20px]'}`} style={{scrollbarWidth:'none'}}>
        ...
        <button className=" px-[21px] text-blue text-[15px]  font-[700] w-max flex gap-[8px]   items-center">
                                                   View All Latest News <Rightarrow />
                                               </button>
...
export default PopularBrandsSection11
