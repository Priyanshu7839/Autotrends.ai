...
import CalculateEmi from "../Components/SideComponents/CalculateEmi.jsx"
...
import Compare from "../Components/CompareTable.jsx"
import videoUrlImg from "../Asset/videourlImg.png"
import arrowTrends from "../Asset/arrowIconTrends.png"

import Brochure from "../Components/SideComponents/Brochure.jsx"
import CarPriceInIndia from '../Components/SideComponents/CarPriceInIndia.jsx'
import TrendingCars from '../Components/SideComponents/TrendingCars.jsx'
...
import SimilarCars from '../Components/SideComponents/SimilarCars.jsx'
import AreYouConfused from '../Components/AreYouConfused.jsx'
import ColorVariations from '../Components/ColorVariations.jsx'
import HighlightImages from '../Components/HighlightImages.jsx'
import MoreOptionsToConsiderData from '../MockData/MoreOptionsToConsiderData.jsx'
import UserReviewForCar from '../Components/UserReviewForCar.jsx'
import VirtualExperience from '../Components/VirtualExperience.jsx'
import { useNavigate } from 'react-router-dom'
import NavigateSection from '../Components/NavigateSection.jsx'
import ReviewAndNewFeature from '../Components/ReviewAndNewFeature.jsx'
        ...
        <div className='parent-div flex justify-center'>
            ...
            <div className=' w-[calc(100%-240px)] mt-[32px] mb-[40px] '>
                ...
                <div className='flex gap-3'>
                    <div className='w-[76%] shadow-md border-[#24272C] border-[1px] rounded-[16px] border-opacity-10 px-[20px] py-[20px] flex flex-col gap-[8px] '>
                        <div>
                ...
                {/* Updates */}
                <div className='mt-[20px] w-[76%] shadow-md border-[#24272C] border-[1px] rounded-[16px] border-opacity-10 px-[20px] py-[20px] flex flex-col gap-[8px] '>
                ...
                <div className='mt-[22px] flex gap-3'>
                    <div className='w-[76%] shadow-md border-[#24272C] border-[1px] rounded-[16px] border-opacity-10  py-[25px] flex flex-col gap-[8px] '>
                ...
                <div className='flex gap-3 mt-[20px] items-center'>
                    <div className='w-[76%] px-[20px] py-[25px] shadow-md  border-[#24272C] border-[1px] rounded-[16px] border-opacity-10 flex flex-col gap-4'>
                ...
                <div className='mt-[20px] w-[76%] px-[20px] py-[20px] shadow-md  border-[#24272C] border-[1px] rounded-[16px] border-opacity-10'>
                ...
                {/* Mileage  */}
                <div className='mt-[20px] w-[76%] px-[20px] py-[20px] shadow-md  border-[#24272C] border-[1px] rounded-[16px] border-opacity-10 flex flex-col gap-4'>
                ...
                {/* Road Test */}
                <div className='w-[76%] mt-[20px] '>
                 <ReviewAndNewFeature data={{heading:"Kia Seltos Road Test",more:"View All Kia Seltos Road Test", features:[{image:roadtest,para1:"Kia Seltos 6000 Km Update: Alibaug In The Summer",para2:"Our long-term Kia Seltos visits Alibaug on its first road trip.",by:"Nabeel" ,date:"Apr 30, 2024"}]}}  />
                </div>
